...
namespace Electric.Application.Auth
{
    ...
    public class EletricAuthorizeAttribute : AuthorizeAttribute, IAuthorizationFilter
    {
        ...
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            var _auditLogManager = context.HttpContext.RequestServices.GetService(typeof(AuditLogManager)) as AuditLogManager;
            var _userManager = context.HttpContext.RequestServices.GetService(typeof(UserManager<EleUser>)) as UserManager<EleUser>;
            var _logger = context.HttpContext.RequestServices.GetService(typeof(ILogger<ElectricExceptionFilterAttribute>)) as ILogger<ElectricExceptionFilterAttribute>;
            ...
            if (hasPermission == null)
            {
                ...
                try
                {
                    _ = _auditLogManager.CreateAsync(auditLog).Result;
                }
