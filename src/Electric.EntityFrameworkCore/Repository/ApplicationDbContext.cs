...
namespace Electric.EntityFrameworkCore.Repository
{
    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        public DbSet<EleAuditLog> AuditLogs { get; set; }
        ...
        private void ConfigureEntityTables(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EleAuditLog>(b =>
            {
                b.ToTable("EleAuditLog");
                b.Property(ul => ul.ApiUrl).HasMaxLength(256);
                b.Property(ul => ul.Method).HasMaxLength(256);
                b.Property(ul => ul.ClientIpAddress).HasMaxLength(64);
                b.Property(ul => ul.BrowserInfo).HasMaxLength(512);
                b.Property(ul => ul.ExceptionMessage).HasMaxLength(1024);
                b.Property(ul => ul.Exception).HasMaxLength(2000);
                b.HasIndex(u => u.CreationTime);
            });
        }
        ...
        private void AddSeedData(ModelBuilder modelBuilder)
        {
            ...
            var logAuditlogId = Guid.NewGuid();
            ...
            var permissionList = new List<ElePermission>
            {
                ...
                new ElePermission(logAuditlogId, emptyParentNode,  "日志管理",  "log.auditlog", PermissionType.Menu, PermissionApiMethod.GET, PermissionStatus.Normal, "bug"),
                #endregion
